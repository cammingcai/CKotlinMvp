package com.camming.mvp.ui.adapter;
...
import com.camming.mvp.ui.view.GlideCircleTransform;
...
public class XViewHolder extends RecyclerView.ViewHolder {
    ...
    public XViewHolder setImageUrl(Context context,@IdRes int viewId, Object imageUrl, int defaultImage) {
        ImageView view = getView(viewId);
        Glide.with(context).load(imageUrl).placeholder(defaultImage).into(view);

        return this;
    }

    public XViewHolder setImageUrl(Context context,@IdRes int viewId, Object imageUrl, BitmapTransformation transformation) {
        ImageView view = getView(viewId);
      //  XImage.getInstance().load(view,imageUrl,transformation);
        Glide.with(context).load(imageUrl)
                .diskCacheStrategy(DiskCacheStrategy.ALL)
                .centerCrop().transform(new GlideCircleTransform(context)).into(view);
        return this;
    }
