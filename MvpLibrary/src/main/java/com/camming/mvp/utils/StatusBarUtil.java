...
public class StatusBarUtil {
     ...
     * @param activity
     */
    public static void justMDarkMode(Activity activity, Boolean b) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            darkModeForM(activity.getWindow(), b);
        }
    }
     ...
     * @param activity
     */
    public static void justMDarkBackground(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
            setTranslucentView((ViewGroup) window.getDecorView(), activity.getResources().getColor(android.R.color.black), DEFAULT_ALPHA);
        } else if (Build.VERSION.SDK_INT >= MIN_API && Build.VERSION.SDK_INT > 16) {
