...
public class XNetworkUtils {
    ...
    private static  XNetworkUtils instance ;
    ...
    public static XNetworkUtils getInstance(Context context) {
        mContext = context;
        if(instance == null){
            synchronized (XNetworkUtils.class){
                if(instance==null)
                    instance = new XNetworkUtils();
            }
        }
