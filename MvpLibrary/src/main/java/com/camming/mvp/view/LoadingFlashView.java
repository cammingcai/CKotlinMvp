...
/**
 * Created by camming on 2017/4/19 0019.
 * logo加载闪烁动画
 */
...
//        mLoad4 = ((ImageView) findViewById(R.id.load4));
    ...
    public void setLoadingTheme(boolean isNight) {
        if (isNight) {
//            PorterDuffColorFilter localPorterDuffColorFilter = new PorterDuffColorFilter(getResources().getColor(R.color.aidea_choice_green), PorterDuff.Mode.SRC_ATOP);
